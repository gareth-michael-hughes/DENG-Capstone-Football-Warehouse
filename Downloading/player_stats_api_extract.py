...
def main():
    ...
    loop_url = "https://api-football-v1.p.rapidapi.com/v2/players/team/{}/2018-2019"
    headers = {
    ...
    flatten = json_normalize(loop_data["api"]['teams'], sep = "_")
    loop_values = flatten['team_id'].tolist()

    # Set the output file path variables
    file_name = 'player-stats-'
    folder_name = '/home/workspace/gh_project/Data/player-stats/'
    ...
    for val in loop_list:
        ...
        load_file_name, object_file_name = response_format(data_nested, file_name, folder_name, \
                    iterable=str(loop_values[val]), loop_col= 'team_id')
        
        # set the object name and upload the file to the s3 bucket
        object_name="player_stats/{}".format(object_file_name)
