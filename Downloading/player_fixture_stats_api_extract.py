...
def main():
    ...
    loop_url = "https://api-football-v1.p.rapidapi.com/v2/players/fixture/{}"
    headers = {
    ...
    file_name = 'fixture-player-stats-'
    folder_name = '/home/workspace/gh_project/Data/fixture-player-stats/'
    ...
    for val in loop_list:
        ...
        object_name="player_fixture_stats/{}".format(object_file_name)
