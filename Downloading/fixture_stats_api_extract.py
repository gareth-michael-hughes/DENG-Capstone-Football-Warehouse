...
def main():
    ...
    loop_url = "https://api-football-v1.p.rapidapi.com/v2/statistics/fixture/{}"
    headers = {
    ...
    file_name = 'fixture-stats-'
    folder_name = '/home/workspace/gh_project/Data/fixture-stats/'
    ...
    for val in loop_list:
        ...
        object_name="fixture_stats/{}".format(object_file_name)
