...
def main():
    ...
    loop_url = "https://api-football-v1.p.rapidapi.com/v2/players/squad/{}/2018-2019"
    headers = {
    ...
    file_name = 'team-squad-'
    folder_name = '/home/workspace/gh_project/Data/team-squads/'
    ...
    for val in loop_list:
        ...
        object_name="team_squads/{}".format(object_file_name)
