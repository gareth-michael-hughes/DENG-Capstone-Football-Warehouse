...
def main():
    ...
    file_name = "/home/workspace/gh_project/Data/player_map/{}"
    folder_name = "/home/workspace/gh_project/Data/player_map/"
    ...
    for file in file_list:
        upload_file_s3(file_name.format(file),bucket=my_bucket, \
                       object_name="player_map/{}".format(file), s3_client=s3_client)
