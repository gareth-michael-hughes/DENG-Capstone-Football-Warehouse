...
def main():
    ...
    file_name = 'lineup-description-'
    folder_name = '/home/workspace/gh_project/Data/fixture-lineups/descriptive/'
    ...
    for val in loop_list:
        ...
        lineup_desc = team_1_desc.append(team_2_desc, ignore_index=True)
        lineup_desc["fixture_id"] = loop_values[val]
        values = lineup_desc.to_json(orient='values')
        ...
        object_name="fixture_lineup_descriptive/{}".format(object_file_name)
