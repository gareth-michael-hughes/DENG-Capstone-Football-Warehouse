...
def main():
    ...
    file_name = "/home/workspace/gh_project/Data/fantasy-ratings/by-gameweek/{}"
    folder_name = "/home/workspace/gh_project/Data/fantasy-ratings/by-gameweek/"
    ...
    for file in file_list:
        upload_file_s3(file_name.format(file),bucket=my_bucket, \
                       object_name="fantasy_gw_ratings/{}".format(file), s3_client=s3_client)
