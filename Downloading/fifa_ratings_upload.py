...
def main():
    ...
    file_name = "/home/workspace/gh_project/Data/fifa-ratings/{}"
    folder_name = "/home/workspace/gh_project/Data/fifa-ratings/"
    ...
    for file in file_list:
        upload_file_s3(file_name.format(file),bucket=my_bucket, \
                       object_name="fifa_ratings/{}".format(file), s3_client=s3_client)
