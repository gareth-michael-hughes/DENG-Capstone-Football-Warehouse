...
def main():
    spark = create_spark_session('gwLineupPlayers')
    ...
    dbtable_read = 'staging_lineups_players'
    ...
    FROM {}
    ORDER BY fixture_id ASC, team_id ASC, player_id ASC
            '''.format(dbtable_read)
    
    # Set the table to write the transformed data to    
    dbtable_write = 'dimGameweekLineupPlayers'
    mode = 'append'
    na_replace_val = 'NULL'
