...
def main():
    spark = create_spark_session('seasonMetricsTeamLoad')
    ...
    dbtable_read = 'staging_standings'
    ...
    query = '''
     ...
     team_id,
     2 AS league_id,
     all_draw AS overall_draws,
     all_goalsAgainst AS overall_goalsAgainst,
     all_goalsFor AS overall_goalsFor,
     all_lose AS overall_lose,
     all_matchsPlayed AS overall_matchesPlayed,
     all_win AS overall_wins,
     away_draw AS away_draws,
     away_goalsAgainst,
     away_goalsFor,
     away_lose,
     away_matchsPlayed AS away_matchesPlayed,
     away_win AS away_wins,
     goalsDiff,
     home_draw AS home_draws,
     home_goalsAgainst,
     home_goalsFor,
     home_lose,
     home_matchsPlayed AS home_matchesPlayed,
     home_win AS home_wins,
     lastUpdate,
     points,
    ...
    dbtable_write = 'factSeasonMetricsTeams'
    mode = 'append'
    na_replace_val = 'NULL'
