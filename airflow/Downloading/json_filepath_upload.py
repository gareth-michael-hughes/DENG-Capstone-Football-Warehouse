...
def main():
    ...
    file_name = "/home/workspace/airflow/Data/json-paths/{}"
    folder_name = "/home/workspace/airflow/Data/json-paths/"
    ...
    for file in file_list:
        upload_file_s3(file_name.format(file),bucket=my_bucket, \
                       object_name="json_path_files/{}".format(file), s3_client=s3_client)
